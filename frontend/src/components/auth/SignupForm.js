        ...
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 font-sans">
            <div className="w-full max-w-6xl mx-auto lg:grid lg:grid-cols-2 shadow-2xl rounded-3xl overflow-hidden lg:h-[85vh] lg:max-h-[700px]">
                    ...
                    <div className="w-full max-w-md mx-auto">
                        ...
                        <div className="grid grid-cols-2 gap-2 bg-slate-100 p-1 rounded-lg mb-6">
                            <button
                                ...
                                className={`py-2 px-4 rounded-md text-sm font-semibold transition-colors ${userType === 'donor' ? 'bg-blue-500 text-white shadow' : 'text-gray-600 hover:bg-slate-200'}`}
                            >
                                I am a Donor
                            </button>
                            <button
                                onClick={() => setUserType('ngo')}
                                className={`py-2 px-4 rounded-md text-sm font-semibold transition-colors ${userType === 'ngo' ? 'bg-blue-500 text-white shadow' : 'text-gray-600 hover:bg-slate-200'}`}
                            >
                                I am an NGO
                            </button>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="relative">
                                ...
                                <input
                                    type="text"
                                    name="name"
                                    placeholder={userType === 'donor' ? 'Full Name' : 'Organization Name'}
                                    value={formData.name}
                            ...
                            <div>
                                <button type="submit" className="w-full bg-blue-500 text-white font-bold py-3 px-4 rounded-lg hover:bg-blue-600 transition-colors duration-300 shadow-lg hover:shadow-blue-500/50 transform hover:-translate-y-0.5">
                                    Create Account
                                </button>
                            </div>
                        </form>
                ...
                <div className="hidden lg:block relative">
                     <img 
                        src="https://cdn.discordapp.com/attachments/1395611202104721448/1397274462298312766/0ac1410b-ca29-4efc-91fe-33383c7de049.png?ex=688120bf&is=687fcf3f&hm=28ac423fa6ad379f3d9a80734ba5a8225fd412677e0e6c1140e1a701a6dd7c29&" 
