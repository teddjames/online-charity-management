...
const featuredCauses = [
  {
    ...
    description:
      "Help us equip a local community library with essential books and learning materials for children who lack access to quality education.",
    amount_needed: 10000,
    amount_received: 4500,
    image_url:
      "https://placehold.co/600x400/E2E8F0/4A5568?text=Education+Cause",
    status: "Approved",
    category: { id: "cat_01", name: "Education" },
    ngo: { organization_name: "Readers to Leaders Initiative" },
  },
  {
    id: "dr_002",
    title: "Medical Supplies for Rural Clinics",
    description:
      "Many rural clinics are struggling with a shortage of basic medical supplies. Your donation can provide life-saving equipment and medicines.",
    amount_needed: 25000,
    amount_received: 18750,
    image_url: "https://placehold.co/600x400/E2E8F0/4A5568?text=Health+Cause",
    status: "Approved",
    category: { id: "cat_02", name: "Health" },
    ngo: { organization_name: "Rural Health Bridge" },
  },
  {
    id: "dr_003",
    title: "Urgent Shelter for Homeless Families",
    description:
      "Support our mission to provide safe and warm shelter for families who have lost their homes. Every contribution helps.",
    amount_needed: 15000,
    amount_received: 6200,
    image_url: "https://placehold.co/600x400/E2E8F0/4A5568?text=Shelter+Cause",
    status: "Approved",
    category: { id: "cat_03", name: "Shelter" },
    ngo: { organization_name: "Safe Haven Community" },
  },
];
        ...
        <div className="mb-4">
          <div className="flex justify-between items-center mb-1">
            <span className="text-sm font-semibold text-gray-700">
              Raised: ${Number(amount_received).toLocaleString()}
            </span>
            <span className="text-sm font-semibold text-gray-500">
              Goal: ${Number(amount_needed).toLocaleString()}
            </span>
          </div>
      ...
      <main>
        ...
        >
          <div
            ...
            style={{
              backgroundImage:
                "url('https://cdn.discordapp.com/attachments/1395611202104721448/1397272495526117426/93c31a9b-41cd-4fb5-a4ec-afbafcfec687.png?ex=68811eeb&is=687fcd6b&hm=baeaae81f9d5cf80b989c5bbde508258d09f9fb93b6902dcea5b044c1c79347f&')",
            }}
          >
